...
<<label=backward>>=
pt.20 <- probtrans(msf.20,direction="backward",predt=5)
pt.201 <- pt.20[[1]]; pt.202 <- pt.20[[2]]
...
<<label=backward2>>=
pt.2040 <- probtrans(msf.2040,direction="backward",predt=5) # patient 20-40
pt.20401 <- pt.2040[[1]]; pt.20402 <- pt.2040[[2]]
pt.40 <- probtrans(msf.40,direction="backward",predt=5) # patient > 40
pt.401 <- pt.40[[1]]; pt.402 <- pt.40[[2]]
@
